      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            ...
            <svg width="250" height="61" viewBox="0 0 491 61" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop offset="1" stop-color="#050505" stop-opacity="0.5"/>
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <Link to="" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Contact</Link>
              </li>
              <li>
