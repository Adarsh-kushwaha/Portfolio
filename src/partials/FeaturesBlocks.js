      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Six Step Process</h2>
            <p className="text-xl text-gray-600"> For fast and easy development process we divided our working process in six sipmle steps let's know one by one.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Sigining a contract which is mutual agreement betwwn client and quinzo.</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-600 text-center">It is convencing prototype of application which will further go under development.</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">UI/UX Desgin</h4>
              <p className="text-gray-600 text-center">A final look of application after that it will go for development process.</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-600 text-center">Development process will start now, at fourth stage.</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Testing</h4>
              <p className="text-gray-600 text-center">Your application will be tested for all possible cases.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Launching</h4>
              <p className="text-gray-600 text-center">Choosing right server for application and launching it.</p>
            </div>
